  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="button" onClick={() => setVibeTag("Necessary")}>Necessary</button>
        <button type="button" onClick={() => setVibeTag("Impulse")}>Impulse</button>
        <button type="button" onClick={() => setVibeTag("Investment")}>Investment</button>
        <button type="button" onClick={() => setVibeTag("Experience")}>Experience</button>
